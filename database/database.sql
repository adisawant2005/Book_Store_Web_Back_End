...
insert into items (item_name, item_description, item_price, item_category, item_rating, item_reviews, item_image_url, item_seller_id, item_quantity) values ('Why_Bharat_Matters', 'The India Way: Strategies for an Uncertain World’ by Dr S Jaishankar', 300, 'World Affairs', 5, 794, 'http://localhost:3000/Items-images/Why_Bharat_Matters.jpg', '618b5735-9b1b-4b0c-bc6b-0f4d7b00434f', 10);
